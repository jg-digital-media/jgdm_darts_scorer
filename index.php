...
<head>
    ...
    <meta property="og:url" content="https://projects.jonniegrieve.co.uk/darts_scorer_app/index.php">
...
<body>
    ...
    <section>
        ...
        <p id="app_intro">This is a simple web application that you can use to score your Darts matches.</p>
